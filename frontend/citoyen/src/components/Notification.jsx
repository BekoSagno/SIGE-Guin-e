...
import { CheckCircle, XCircle, AlertTriangle, Info, X, Zap } from 'lucide-react';
...
export function NotificationProvider({ children }) {
  ...
  const notify = {
    ...
    energy: (message, options = {}) =>
      addNotification({ type: 'energy', message, ...options }),
